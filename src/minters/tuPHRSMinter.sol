...
contract ERC20MinterRedeem is BaseMinterRedeem, ERC20Minter {
    ...
    constructor(
        address _baseToken,
        address _stakingToken
    ) ERC20Minter(_baseToken, _stakingToken) {}
...
abstract contract BaseMinterWithdrawal is
    BaseMinter,
    ERC721,
    ERC721Enumerable,
    ERC721Burnable
{
    ...
    ) public view returns (WithdrawalRequest memory) {
    ...
    function processWithdrawals(
        ...
        for (uint256 i = 0; i < withdrawalIds.length; i++) {
            ...
            WithdrawalRequest storage request = _withdrawalRequests[
                withdrawalId
            ];
        ...
        require(
            totalWithdrawals <= totalPendingWithdrawals,
            "TotalWithrawalAmountExceeded"
        );
...
contract NativeMinterWithdrawal is BaseMinterWithdrawal, NativeMinter {
    constructor(
        ...
        BaseMinterWithdrawal(_unstTokenName, _unstTokenSymbol)
        NativeMinter(_stakingToken)
    {}
    ...
    function withdraw(address receiver) public virtual override onlyOwner {
